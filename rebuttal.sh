...
#SNAP
java -Xss1G -cp $CLASSPATHS shell.TestSNAP wikivote.txt.gz 10 100 2021
java -Xss1G -cp $CLASSPATHS shell.TestSNAP slashdot.txt.gz 10 100 2021
java -Xms8G -Xmx48G -Xmn16G -Xss1G -cp $CLASSPATHS shell.TestSNAP twitter_combined.txt.gz 10 100 2021

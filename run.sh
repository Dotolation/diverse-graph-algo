...
java -Xms16G -Xmx32G -Xmn16G -Xss1G -cp $CLASSPATHS shell.TestSNAP wikivote.txt.gz 10 340
java -Xms16G -Xmx32G -Xmn16G -Xss1G -cp $CLASSPATHS shell.TestSNAP slashdot.txt.gz 10 340
